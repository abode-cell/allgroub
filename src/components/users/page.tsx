...
const UserActions = ({ user, onDeleteClick, onEditClick }: { user: User, onDeleteClick: (user: User) => void, onEditClick: (user: User) => void }) => {
  const { currentUser, updateUserStatus } = useDataState();
...
export default function UsersPage() {
  const { currentUser, users, investors, updateUserRole, deleteUser, updateUserLimits, updateManagerSettings, updateAssistantPermission, updateEmployeePermission, addNewSubordinateUser, updateUserCredentials, addBranch, deleteBranch } =
    useDataState();
