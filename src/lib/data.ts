...
export const usersData: User[] = [
  ...
  { id: '2', name: 'مدير المكتب', email: 'manager@example.com', role: 'مدير المكتب', status: 'نشط', photoURL: 'https://placehold.co/40x40.png', password: 'password123', phone: '0500000002', registrationDate: '2023-01-12', investorLimit: 10, employeeLimit: 5, assistantLimit: 2, allowEmployeeSubmissions: true, hideEmployeeInvestorFunds: false, permissions: {} },
