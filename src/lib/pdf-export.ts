...
export const exportToPdf = ({
  ...
  autoTable(doc, {
    ...
    didDrawPage: (data) => {
      ...
      const pageNumText = `صفحة ${doc.internal.getNumberOfPages()}`;
      doc.text(pageNumText, pageWidth / 2, pageHeight - 10, {
        align: 'center',
      });
    },
  });
